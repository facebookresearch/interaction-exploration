...
# [!!] from habitat_baselines.common.utils
...
# [++] BaseEncoder for all policies
class BaseEncoder(nn.Module):
    def __init__(self, observation_space, hidden_size, visual_encoder, state_encoder, **kwargs):
        super().__init__()
        self._hidden_size = hidden_size
        self.visual_encoder = visual_encoder(observation_space, hidden_size, **kwargs)
        self.state_encoder = state_encoder(self._hidden_size, self._hidden_size)
        self.train()
